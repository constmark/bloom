...
Start with the project [README](../README.md) for installation and a first
request.
...
- [Plugins and processors](plugins.md)
- [World-model schema](world-model.md)

## Maintain Bloom

- [Development](development.md)
- [Security boundaries](security.md)
- [Performance checks](performance_budgets.md)
- [Roadmap](roadmap.md)
